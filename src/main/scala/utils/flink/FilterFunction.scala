...
class FilterFunctionWithLatency extends RichFlatMapFunction[(String,String,String, Long),(String,String,String, Long)] {

  private var seen: ValueState[Boolean] = _

  override def flatMap(value: (String,String,String, Long), out: Collector[(String,String,String, Long)]): Unit = {
